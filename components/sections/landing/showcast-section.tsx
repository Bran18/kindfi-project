...
const LatamWeb3Platform = () => {
  ...
  const FeatureCard = ({ title, description, icon, stats, checkList }: any) => (
    ...
    >
      ...
      {stats && (
        <div className="bg-gradient-to-r from-teal-50 to-teal-50/50 rounded-xl p-4 mb-4">
          <div className="text-2xl font-bold text-teal-700 mb-1">
            {stats.value}
          </div>
          <div className="text-sm text-teal-600">{stats.label}</div>
        </div>
      )}
    ...
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="relative container mx-auto px-4">
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
        >
          <Card className="bg-gradient-to-r from-teal-50 to-white max-w-4xl mx-auto border-none shadow-sm">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                opportunity to create measurable social change. Our smart escrow
                system, powered by Trustless work, ensures that funds are
                released only when goals are met. Blockchain traceability
                guarantees full transparency and accountability for every
                collaboration. Together, building a bridge between the
                blockchain crypto world and meaningful social impact across the
                world.
              </p>
            </CardContent>
          </Card>
